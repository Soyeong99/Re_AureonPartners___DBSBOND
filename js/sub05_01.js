...
$(function () {
  ...
  function changeTab(index) {
    ...
    // 부드러운 전환 효과 적용
    contents.eq(currentIndex).stop().fadeOut(200, function () {
...
$(document).ready(function () {
  ...
  $("input[name='check_01']").click(function () {
    if ($("input[name='check_01']:checked").length == $("input[name='check_01']").length) {
...
$(document).ready(function () {
  ...
  $("input[name='check_02']").click(function () {
    if ($("input[name='check_01']:checked").length == $("input[name='check_02']").length) {
